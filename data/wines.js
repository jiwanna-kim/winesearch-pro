...
const DOMAINES_DATA = [
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Meursault_-_Vineyards_-_1.jpg/400px-Meursault_-_Vineyards_-_1.jpg",
    wines: [
      {
        id: "w1",
        ...
        type: "Blanc",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bb/Bourgogne_blanc%2C_Joseph_Drouhin%2C_2007.jpg/300px-Bourgogne_blanc%2C_Joseph_Drouhin%2C_2007.jpg",
        vintages: [
      ...
      },
      {
        ...
        type: "Blanc",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/Corton_Charlemagne_Grand_Cru_Latour.JPG/300px-Corton_Charlemagne_Grand_Cru_Latour.JPG",
        vintages: [
...

  {
    ...
    wines: [
      ...
      },
      {
        ...
        type: "Blanc",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/Puligny-Montrachet_bottle.jpg/300px-Puligny-Montrachet_bottle.jpg",
        vintages: [
          { year: 2020, rvf_score: 20, critics: {
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Chablis_Grand_Cru_vineyards.jpg/400px-Chablis_Grand_Cru_vineyards.jpg",
    wines: [
      {
        id: "w7",
        ...
        type: "Blanc",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Chablis_bottle_and_wine.jpg/300px-Chablis_bottle_and_wine.jpg",
        vintages: [
          { year: 2021, rvf_score: 19, critics: {
      ...
      },
      {
        ...
        type: "Blanc",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Chablis_Blanchots_1979_bottle_variation.jpg/300px-Chablis_Blanchots_1979_bottle_variation.jpg",
        vintages: [
          { year: 2021, rvf_score: 18, critics: {
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Volnay_Vineyard_%28157453981%29.jpeg/400px-Volnay_Vineyard_%28157453981%29.jpeg",
    wines: [
      {
        id: "w9",
        ...
        type: "Rouge",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Several_Gevrey-Chambertin_bottles.jpg/300px-Several_Gevrey-Chambertin_bottles.jpg",
        vintages: [
          { year: 2020, rvf_score: 19, critics: {
      ...
      },
      {
        ...
        type: "Rouge",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2d/Vignobles_de_Pommard_en_automne_%282018%29.JPG/300px-Vignobles_de_Pommard_en_automne_%282018%29.JPG",
        vintages: [
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/19/Champagne_vineyard_and_Church.jpg/400px-Champagne_vineyard_and_Church.jpg",
    wines: [
      {
        id: "w11",
        ...
        type: "Effervescent",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/Blanc_de_Noirs_--_Champagne_Devaux.png/300px-Blanc_de_Noirs_--_Champagne_Devaux.png",
        vintages: [
      ...
      },
      {
        ...
        appellation: "Champagne Grand Cru Ambonnay",
        type: "Effervescent",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fe/De_Venoge_Cordon_Bleu_Brut_Champagne.jpg/300px-De_Venoge_Cordon_Bleu_Brut_Champagne.jpg",
        vintages: [
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/Vosne-Roman%C3%A9e%2C_Domaine_de_la_Roman%C3%A9e-Conti_%281%29.JPG/400px-Vosne-Roman%C3%A9e%2C_Domaine_de_la_Roman%C3%A9e-Conti_%281%29.JPG",
    wines: [
      {
        id: "w15",
        name: "Romanée-Conti",
        ...
        type: "Rouge",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/Bouteille_de_Roman%C3%A9e_Conti.JPG/300px-Bouteille_de_Roman%C3%A9e_Conti.JPG",
        vintages: [
      ...
      },
      {
        ...
        type: "Rouge",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Grands-%C3%A9chezeaux.JPG/300px-Grands-%C3%A9chezeaux.JPG",
        vintages: [
          { year: 2019, rvf_score: 20, critics: {
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Chateau_Petrus_wijngaard.jpg/400px-Chateau_Petrus_wijngaard.jpg",
    wines: [
      {
        id: "w18",
        name: "Pétrus",
        ...
        type: "Rouge",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Several_bottles_of_1982_Petrus.jpg/300px-Several_bottles_of_1982_Petrus.jpg",
        vintages: [
          { year: 2021, rvf_score: 19, critics: {
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a1/Cote_rotie.jpg/400px-Cote_rotie.jpg",
    wines: [
      {
        id: "w19",
        ...
        type: "Rouge",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Guigal_Crozes_Hermitage.JPG/300px-Guigal_Crozes_Hermitage.JPG",
        vintages: [
          { year: 2019, rvf_score: 19, critics: {
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9b/Vineyard_in_Chateauneuf_du_Pape.jpg/400px-Vineyard_in_Chateauneuf_du_Pape.jpg",
    wines: [
      {
        id: "w20",
        ...
        type: "Rouge",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9b/Vineyard_in_Chateauneuf_du_Pape.jpg/300px-Vineyard_in_Chateauneuf_du_Pape.jpg",
        vintages: [
          { year: 2020, rvf_score: 20, critics: {
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2d/Vineyards_Gevrey-Chambertin.jpg/400px-Vineyards_Gevrey-Chambertin.jpg",
    wines: [
      {
        id: "w21",
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/Saint-Emilion_ch%C3%A2teau_Ausone.jpg/400px-Saint-Emilion_ch%C3%A2teau_Ausone.jpg",
    wines: [
      {
        id: "w27",
        ...
        type: "Rouge",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0a/Leoville-las-Cases-1975.JPG/300px-Leoville-las-Cases-1975.JPG",
        vintages: [
          { year: 2022, rvf_score: 19, critics: {
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/39/Fleurie_69_La_Madone.jpg/400px-Fleurie_69_La_Madone.jpg",
    wines: [
      {
        id: "w29",
        ...
        type: "Rouge",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Fleurie_AOC.jpg/300px-Fleurie_AOC.jpg",
        vintages: [
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Morey-Saint-Denis_-_01.jpg/400px-Morey-Saint-Denis_-_01.jpg",
    wines: [
      {
        id: "w31",
        ...
        type: "Rouge",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Chambolle_Musigny_AC_Domaine_Christian_Clerget_%40_Fareham_Wine_Cellar.jpg/300px-Chambolle_Musigny_AC_Domaine_Christian_Clerget_%40_Fareham_Wine_Cellar.jpg",
        vintages: [
          { year: 2020, rvf_score: 18, critics: {
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/Vosne-Roman%C3%A9e_Domaine_de_la_Roman%C3%A9e-Conti.jpg/400px-Vosne-Roman%C3%A9e_Domaine_de_la_Roman%C3%A9e-Conti.jpg",
    wines: [
      {
        id: "w32",
        ...
        type: "Rouge",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Chambolle-Musigny_1er_Cru_Les_amoureuses.JPG/300px-Chambolle-Musigny_1er_Cru_Les_amoureuses.JPG",
        vintages: [
          { year: 2019, rvf_score: 19, critics: {
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Ch%C3%A2teauChevalBlanc.jpg/400px-Ch%C3%A2teauChevalBlanc.jpg",
    wines: [
      {
        id: "w33",
        name: "Château Cheval Blanc",
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Chateau_Ducru_Beaucaillou%2C_Saint_Julien_vineyards.jpg/400px-Chateau_Ducru_Beaucaillou%2C_Saint_Julien_vineyards.jpg",
    wines: [
      {
        id: "w34",
        name: "Château Léoville Las Cases",
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/Pernand-Vergelesses-Vignoble_06.jpg/400px-Pernand-Vergelesses-Vignoble_06.jpg",
    wines: [
      {
        id: "w35",
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Vouvray_Vineyard_after_budbreak.jpg/400px-Vouvray_Vineyard_after_budbreak.jpg",
    wines: [
      {
        id: "w37",
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Sancerre_vineyards.jpg/400px-Sancerre_vineyards.jpg",
    wines: [
      {
        id: "w38",
        ...
        type: "Rouge",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Sancerre_vineyards.jpg/300px-Sancerre_vineyards.jpg",
        vintages: [
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/Vignoble_de_pouilly-fum%C3%A9.jpg/400px-Vignoble_de_pouilly-fum%C3%A9.jpg",
    wines: [
      {
        id: "w39",
        ...
        type: "Blanc",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/Vignoble_de_pouilly-fum%C3%A9.jpg/300px-Vignoble_de_pouilly-fum%C3%A9.jpg",
        vintages: [
          { year: 2022, rvf_score: 16, critics: {
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Chateauneuf-du-pape-rhone.jpg/400px-Chateauneuf-du-pape-rhone.jpg",
    wines: [
      {
        id: "w41",
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Vine_in_the_vineyard_in_Kaysersberg.jpg/400px-Vine_in_the_vineyard_in_Kaysersberg.jpg",
    wines: [
      {
        id: "w42",
        ...
        type: "Blanc",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Alsace_Riesling_2007.jpg/300px-Alsace_Riesling_2007.jpg",
        vintages: [
          { year: 2021, rvf_score: 17, critics: {
    ...
    wines: [
      {
        ...
        type: "Blanc",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1e/Bouteille_type_muscadet_1.jpg/300px-Bouteille_type_muscadet_1.jpg",
        vintages: [
          { year: 2022, rvf_score: 16, critics: {
...

  {
    ...
    hero_image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/Red_Bandol_wine_from_Provence.jpg/400px-Red_Bandol_wine_from_Provence.jpg",
    wines: [
      {
        id: "w44",
        name: "Bandol Rouge",
        ...
        type: "Rouge",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/Red_Bandol_wine_from_Provence.jpg/300px-Red_Bandol_wine_from_Provence.jpg",
        vintages: [
          { year: 2020, rvf_score: 17, critics: {
